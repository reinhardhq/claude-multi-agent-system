#!/bin/bash
# ==============================================================================
# Worktree Manager - Git Worktreeマルチエージェント開発管理
# ==============================================================================
# Description: 各Workerが独立したワークスペースで並列開発するためのシステム
# Usage: worktree-manager.sh [init|create|remove|status|sync|deploy|cleanup]
# Dependencies: git
# ==============================================================================
